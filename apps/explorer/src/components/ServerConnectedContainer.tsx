import { Alert, Anchor, Button, Code, Loader, Tabs, Text } from '@mantine/core'
...
import classes from './ServerConnectedContainer.module.css'
...
export default function ServerConnectedContainer(props: Props) {
